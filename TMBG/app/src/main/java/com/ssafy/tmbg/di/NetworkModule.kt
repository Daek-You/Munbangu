...
object NetworkModule {
    ...
    @Provides
    @Singleton
    fun provideAuthInterceptor(serverTokenManager: ServerTokenManager): AuthInterceptor {
        return AuthInterceptor(serverTokenManager)
    }
    ...
    fun provideOkHttpClient(
        ...
        return OkHttpClient.Builder()
            ...
            .addInterceptor(authInterceptor)     // 인증
    ...
    fun provideRetrofit(okHttpClient: OkHttpClient): Retrofit {
        return Retrofit.Builder()
            .baseUrl(BuildConfig.BASE_URL)  // URL을 BuildConfig로 관리
            .client(okHttpClient)
